...
La documentation de référence suivante est générée à partir du `composer.lock` et couvre les packages requis inclus dans Adobe Commerce sur l’infrastructure cloud 2.4.7.

## Dépendances

`magento/magento-cloud-metapackage 2.4.7` a les dépendances suivantes :
...
<table>
  ...
  <tr>
    <td>
      <a href="https://github.com/illuminate/config.git">illuminer/configurer</a>
    </td>
    <td>bibliothèque</td>
  ...
  <tr>
    <td>
      <a href="https://github.com/illuminate/macroable.git">illuminer/macrotable</a>
    </td>
    <td>bibliothèque</td>
  ...
  <tr>
    <td>
      <a href="https://github.com/symfony/translation.git">symphonie/traduction</a>
    </td>
    <td>bibliothèque</td>
